...
[mo.pla]{style="background-color: #ea6212; color: white"} $\neq$ [mop.la]{style="background-color: #781478; color: white"}
...
[mo.pla]{style="background-color: #ea6212; color: white"} $\gt$ [mop.la]{style="background-color: #781478; color: white"}
...
[mop.pla]{style="background-color: #781478; color: white"} $\neq$ [mop]{style="background-color: green; color: white"}
