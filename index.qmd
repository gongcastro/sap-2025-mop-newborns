...
::: box
Is the MOP an available **mechanism for detecting syllables at birth**?
:::
...
Functional nea-infrared light spoctroscopy (**fNIRS**):
...
In some experimental paradigms, newborns exclusively rely on 1st syllables [@flo2022sleeping]
...
| **List** | **Condition** | **Syllabification** | **Words** |
|----------|---------------|---------------------|-----------|
| List 1   | [Standard (ST)]{style="background-color: #5778a4; color: white"}         | CV-CCV              | MO-PLA, SA-KLO, TI-PLE, DE-KLI | 
...
| List 2   | [Standard (ST)]{style="background-color: #5778a4; color: white"}         | CV-CCV              | MO-KLA, SA-PLO, TI-KLE, DE-PLI |
...
ggplot(participants_plot_data, aes(age)) +
  ...
  geom_dots(layout = "weave", na.rm = TRUE, fill = clrs[1]) +
